...
public class AccountButtonListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (parent.customerList.isEmpty()) {
			JOptionPane.showMessageDialog(parent.f, "There are no customers yet!", "Oops!", JOptionPane.INFORMATION_MESSAGE);
			parent.f.dispose();
			parent.admin();
		} else {
			boolean loop = true;
			...
			while (loop) {
				...
				if (found == false) {
					...
					if (account.equals("Current Account")) {
						...
						JOptionPane.showMessageDialog(parent.f, "Account number = " + number + "\n PIN = " + pin,
					...
					if (account.equals("Deposit Account")) {
						...
						JOptionPane.showMessageDialog(parent.f, "Account number = " + number, "Account created.",
