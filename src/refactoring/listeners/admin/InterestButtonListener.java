					...
					if (parent.customer.getAccounts().isEmpty()) {
						...
						continueButton.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent ae) {
								...
								while (loop) {
									String interestString = JOptionPane.showInputDialog(parent.f,
									...
									if (parent.isNumeric(interestString)) {
										...
										parent.acc.setBalance(
												parent.acc.getBalance() + (parent.acc.getBalance() * (interest / 100)));

										JOptionPane.showMessageDialog(parent.f,
												interest + "% interest applied. \n new balance = "
														+ parent.acc.getBalance() + euro,
												"Success!", JOptionPane.INFORMATION_MESSAGE);
									}

									else {
										JOptionPane.showMessageDialog(parent.f, "You must enter a numerical value!",
												"Oops!", JOptionPane.INFORMATION_MESSAGE);
									}
